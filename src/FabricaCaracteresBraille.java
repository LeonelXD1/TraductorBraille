...
/**
 * Clase que implementa el patrón Singleton para crear y gestionar caracteres
 * Braille.
 * Mantiene un mapa de todos los caracteres disponibles y sus representaciones
 * Braille.
 * Incluye soporte para letras, números, signos de puntuación, acentos y
...
public class FabricaCaracteresBraille {
    ...
    /**
     * Inicializa el mapa con todas las letras del alfabeto (a-z) y sus
     * representaciones Braille.
     */
    ...
    /**
     * Inicializa el mapa con todos los números (0-9) y sus representaciones
     * Braille.
     */
    ...
    /**
     * Inicializa el mapa con los signos de puntuación más comunes y sus
     * representaciones Braille.
     * Incluye: punto, coma, punto y coma, dos puntos, exclamación, interrogación y
     * espacio.
     */
    ...
    /**
     * Inicializa el mapa con los caracteres acentuados del español y sus
     * representaciones Braille.
    ...
    /**
     * Inicializa el mapa con símbolos matemáticos básicos y sus representaciones
     * Braille.
     ...
     * 
     * @param caracter El carácter del cual se desea obtener su representación
     *                 Braille
    ...
    /**
     * Compara dos arrays de booleanos que representan puntos Braille.
     * 
     * @param a Primer array de puntos.
     * @param b Segundo array de puntos.
     * @return true si ambos arrays tienen el mismo contenido, false en caso
     *         contrario.
     */
    ...
    /**
     * Busca un carácter basándose en los puntos y en el contexto (si esperamos
     * número o letra).
     * 
     * @param puntosBusqueda Array de booleanos con la configuración de puntos a
     *                       buscar.
     * @param modoNumero     Indica si se debe priorizar la búsqueda de números
     *                       (true) o letras (false).
     * @return El carácter encontrado que coincide con los puntos y el contexto, o
